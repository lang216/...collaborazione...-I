...
try:
    ...
    input_dir = Path(__file__).parent / config_data["paths"]["input_dir"]
    segments_dir = Path(__file__).parent / config_data["paths"]["segments_dir"]
    filtered_dir = Path(__file__).parent / config_data["paths"]["filtered_segments_dir"]
    freesound_dir = Path(__file__).parent / config_data["paths"]["freesound_dir"]
